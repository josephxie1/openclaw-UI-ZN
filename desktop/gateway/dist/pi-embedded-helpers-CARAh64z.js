import { d as resolveSessionAgentId, r as resolveAgentConfig } from "./agent-scope-DOGlT2cV.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-D5QmGXIi.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-D5QmGXIi.js")).closePlaywrightBrowserConnection();
		} catch {}
