...
import { t as ensureOpenClawModelsJson } from "./models-config-CAdryvBR.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-Bu5v15pj.js";
...
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-ENyTm-5-.js";
...
import { r as resolveForwardCompatModel } from "./model-P7M6Dofd.js";
...
import { n as runCommandWithRuntime, t as resolveOptionFromCommand } from "./cli-utils-BbBvzQDf.js";
import "./help-format-Cr_Q2w-E.js";
import { r as withProgressTotals } from "./progress-BQ1mGU5R.js";
...
import { f as openUrl } from "./onboard-helpers-D2emUd7N.js";
...
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-OLS7OBYV.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-C8Q-8JjF.js";
import { n as logConfigUpdated } from "./logging-cirizFZh.js";
import { a as createVpsAwareOAuthHandlers, c as githubCopilotLoginCommand, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-BaTkgpB7.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./model-selection-82PVSbGK.js").then((n) => n.Lt);
	const { ensureAuthProfileStore } = await import("./model-selection-82PVSbGK.js").then((n) => n.dt);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-P7M6Dofd.js").then((n) => n.t);
