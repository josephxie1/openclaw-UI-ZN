...
import { m as restoreTerminalState, p as defaultRuntime } from "./subsystem-VTlWhMKb.js";
...
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-D2emUd7N.js";
...
import { i as normalizeLegacyOnboardAuthChoice, r as isDeprecatedAuthChoice, t as ONBOARD_PROVIDER_AUTH_FLAGS } from "./onboard-provider-auth-flags-Zn1H0Oo2.js";
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-CUPHi8aj.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-D65YWUQS.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-BYYntW0C.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-xN7g3Vir.js").then((n) => n.i);
